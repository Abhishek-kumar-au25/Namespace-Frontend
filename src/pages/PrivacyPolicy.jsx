      ...
      <footer className="py-8 border-t border-white/5 bg-[#08080C]">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex justify-center gap-6 mt-4">
            ...
            <Link to="/privacy" className="text-sm text-purple-400">Privacy</Link>
            <Link to="/cookies" className="text-sm text-gray-400 hover:text-purple-400 transition-colors">Cookies</Link>
          </div>
        </div>
      </footer>
    </div>
